...
public class InventoryPopulator : MonoBehaviour
{
    ...
    public int itemSize;
    public GameObject sceneChangeInventoryHolder;
    ...
    public void gfClick()
    {
        ...
        for (int i = 0; i < itemSize; i++)
        {
            ...
            //randomItem.GetComponent<ItemInfo>().currentItem = allItems[Random.Range(0, allItems.Count)];
            //itemIcon.sprite = itemData.currentItem.icon;
